...
public class ParserSoftech { public static synchronized List getAllPageDeviceSoftech(String link) throws IOException {
    ...
    for (int i = 0; i < nameList.size(); i++) {
        if (ParserMethod.equalsString(nameList.get(i), link)){
